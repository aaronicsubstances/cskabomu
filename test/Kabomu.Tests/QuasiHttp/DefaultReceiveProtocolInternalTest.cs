...
namespace Kabomu.Tests.QuasiHttp
{
    public class DefaultReceiveProtocolInternalTest
    {
        ...
        public static List<object[]> CreateTestReceiveData()
        {
            ...
            var reqBodyBytes = MiscUtils.StringToBytes("this is our king");
            ...
            byte[] expectedResBodyBytes = MiscUtils.StringToBytes("and this is our queen");
            ...
            reqBodyBytes = MiscUtils.StringToBytes("<a>this is news</a>");
            request.Body = new ByteBufferBody(reqBodyBytes)
            {
                ContentLength = -1
            };
            ...
            expectedResBodyBytes = MiscUtils.StringToBytes("<a>this is news</a>");
            expectedResponse.Body = new LambdaBasedQuasiHttpBody
            {
                ContentLength = expectedResBodyBytes.Length
            };
